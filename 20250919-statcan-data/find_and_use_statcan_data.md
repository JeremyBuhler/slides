...
With microdata you have the raw material and need to do your own aggregation and analysis, but this gives you more flexibility. 
...
- Some variables are suppressed <!-- .element class="fragment" -->  
- Some variables are grouped  <!-- .element class="fragment" --> 
- Sometimes only a sample of responses <!-- .element class="fragment" --> 
